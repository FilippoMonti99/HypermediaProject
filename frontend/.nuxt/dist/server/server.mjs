...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/about-0b530b5d.js").then((m) => m.default || m)
  },
  {
    name: "areas-id",
    path: "/areas/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_id_-6b2d4d3d.js").then((m) => m.default || m)
  },
  {
    name: "areas",
    path: "/areas",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-dfb1875f.js").then((m) => m.default || m)
  },
  {
    name: "contact",
    path: "/contact",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/contact-3759fd60.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-4bcf2b7d.js").then((m) => m.default || m)
  },
  {
    name: "mostrelevant",
    path: "/mostrelevant",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-21625dfa.js").then((m) => m.default || m)
  },
  {
    name: "people-id",
    path: "/people/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_id_-60338673.js").then((m) => m.default || m)
  },
  {
    name: "people",
    path: "/people",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-da55e844.js").then((m) => m.default || m)
  },
  {
    name: "projects-id",
    path: "/projects/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_id_-d33b49a4.js").then((m) => m.default || m)
  },
  {
    name: "projects",
    path: "/projects",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-41dd07b5.js").then((m) => m.default || m)
  }
];
...
const layouts = {
  default: /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/default-8b24c618.js").then((m) => m.default || m))
};
